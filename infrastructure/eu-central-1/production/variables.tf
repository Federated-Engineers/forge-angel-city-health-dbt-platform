variable "github_repos" {
  ...
  default = [
    "repo:Federated-Engineers@242844222/forge-angel-city-health-dbt-platform@1240885359:ref:refs/heads/main",
    "repo:Federated-Engineers@242844222/forge-angel-city-health-dbt-platform@1240885359:*" # To Do: This line for testing only, remove it after testing is done
  ]
  sensitive = false
  nullable  = false
